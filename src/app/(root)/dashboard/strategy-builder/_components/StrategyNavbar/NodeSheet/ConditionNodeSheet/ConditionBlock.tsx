...
export const ConditionBlock: React.FC<ConditionBlockProps> = ({
  ...
  return (
    <Accordion type="single" collapsible className="w-full border border-gray-700 rounded-lg ">
      <AccordionItem value="item-1">
        <AccordionTrigger className="px-4 underline">
          Group
        ...
        <div className=" relative">
          <div className=" dark:border-gray-800 rounded-lg p-2 px-10 dark:bg-gray-900 ">
